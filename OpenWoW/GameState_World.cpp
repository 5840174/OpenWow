...
void CGameState_World::Load3D()
{
    ...
    AddMCNKPasses(renderDevice, m_RenderTarget, &m_3D2Technique, renderWindow->GetViewport()2, m_3DScene);
    AddWMOPasses(renderDevice, m_RenderTarget, &m_3D2Technique, renderWindow->GetViewport()2, m_3DScene);
    AddLiquidPasses(renderDevice, m_RenderTarget, &m_3D2Technique, renderWindow->GetViewport()2, m_3DScene);
    AddM2Passes(renderDevice, m_RenderTarget, &m_3D2Technique, renderWindow->GetViewport()2, m_3DScene);
    */
