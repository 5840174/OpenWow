...
enum class ZN_API GameobjectTypes : uint32
{
...
enum class ZN_API CreatureType : uint32
{
...
enum class ZN_API CreatureTypeFlags : uint32
{
...
enum class ZN_API CreatureFamily : uint32
{
