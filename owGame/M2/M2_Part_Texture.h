...
class ZN_API CM2_Part_Texture
{
public:
	CM2_Part_Texture(const IBaseManager& BaseManager, IRenderDevice& RenderDevice, const CM2& M2Object, const std::shared_ptr<IByteBuffer>& File, const SM2_Texture& M2Texture);
